...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'address_locality', 'postal_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    models = {
        u'address.address': {
            ...
            'unformatted': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'address.country': {
